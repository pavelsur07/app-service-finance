...
**D4 — экспорт XLSX.** То же, что D3: одна строка на split. Ломает формат для внешних
парсеров выгрузки; альтернатива (склейка категорий в ячейку) ломает суммирование в Excel.
Если выгрузка питает 1С или внешнюю таблицу — сказать до Stage 3.
