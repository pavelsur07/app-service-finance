...
- Карточка показывает последний запуск, счётчики, безопасную категорию ошибки и время последнего полного прохода. Чтение статусов страницы выполняется одним tenant-scoped запросом без N+1.
