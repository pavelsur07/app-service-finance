...
- Примечание: открытые вопросы временно могут лежать в корне репозитория, но обязаны быть перечислены в этом разделе.

## Runbooks (операционка)
- Docker cleanup: `CLEAR.MD`
- Примечание: runbook-документы временно могут лежать в корне репозитория, но обязаны быть перечислены в этом разделе.
