...
#[ORM\Entity(repositoryClass: ExternalCategoryCompanyMappingRepository::class)]
#[ORM\Table(name: 'ingest_external_category_company_mappings')]
#[ORM\UniqueConstraint(name: 'uniq_ingest_ext_category_company_mapping', columns: ['external_category_id', 'company_id'])]
#[ORM\Index(name: 'idx_ingest_ext_category_company_mapping_status', columns: ['company_id', 'status', 'updated_at'])]
class ExternalCategoryCompanyMapping
{
    #[ORM\Id]
