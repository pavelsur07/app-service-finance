                ...
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: 'details_message', type: 'string', nullable: true),
                            new OA\Property(property: 'exception_class', type: 'string', nullable: true),
                            ...
                            new OA\Property(property: 'fetched_at', type: 'string', nullable: true, example: '2026-06-15T10:00:00Z'),
                        ],
                        type: 'object',
                    ),
                ),
