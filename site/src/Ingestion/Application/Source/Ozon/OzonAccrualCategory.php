...
final readonly class OzonAccrualCategory
{
    ...
    public static function all(): array
    {
        ...
        $cache = [
            ...
            new self('ozon_logistics', 'Логистика', 'Услуги доставки', TransactionType::LOGISTICS, 400, typeIds: ['29']),
            new self('ozon_reverse_logistics', 'Обратная логистика', 'Услуги доставки', TransactionType::LOGISTICS, 410),
            new self('ozon_delivery_to_pickup_ozon', 'Доставка до места выдачи силами Ozon', 'Услуги доставки', TransactionType::LAST_MILE, 420, typeIds: ['45']),

            new self('ozon_partner_return_processing', 'Обработка возвратов, отмен и невыкупов партнёрами', 'Услуги партнёров', TransactionType::FEE, 500),
            new self('ozon_acquiring', 'Эквайринг', 'Услуги партнёров', TransactionType::ACQUIRING, 510, aliases: ['Эквайринг Ozon']),
            new self('ozon_partner_packaging', 'Упаковка товара партнёрами', 'Услуги партнёров', TransactionType::FEE, 520),
            new self('ozon_delivery_to_pickup_partners', 'Доставка до места выдачи партнёрами', 'Услуги партнёров', TransactionType::LAST_MILE, 530),
            ...
            new self('ozon_cross_docking', 'Кросс-докинг', 'Услуги FBO', TransactionType::LOGISTICS, 600, parentLabel: 'Доставка до склада'),
            ...
            new self('ozon_incomplete_supply_booking', 'Бронирование места и персонала для поставки с неполным составом', 'Услуги FBO', TransactionType::ACCEPTANCE, 800, parentLabel: 'Услуги приёмки'),
