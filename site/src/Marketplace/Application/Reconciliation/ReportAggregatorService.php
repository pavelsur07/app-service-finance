...
final class ReportAggregatorService
{
    ...
    public function aggregate(string $period, array $classifiedRows, array $baseSignMap): array
    {
        ...
        return [
            ...
            'groupNetByServiceGroup' => array_map(static fn ($v) => round($v, 2), $groups),
        ];
    }
}
