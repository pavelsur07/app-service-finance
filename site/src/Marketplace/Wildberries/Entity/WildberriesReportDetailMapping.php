...
#[ORM\UniqueConstraint(name: 'uniq_wb_mapping_company_oper_doc_country_source', columns: ['company_id', 'supplier_oper_name', 'doc_type_name', 'site_country', 'source_field'])]
