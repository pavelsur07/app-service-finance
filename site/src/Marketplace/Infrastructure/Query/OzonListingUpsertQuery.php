...
final class OzonListingUpsertQuery
{
     ...
     * @param string|null $supplierSku supplier_sku / offer_id (может отсутствовать)
     */
    public function upsertIfNotExists(string $companyId, string $sku, ?string $name, ?string $supplierSku = null): void
    {
        ...
        $this->connection->executeStatement(
            ...
            INSERT INTO marketplace_listings
                (id, company_id, marketplace, marketplace_sku, supplier_sku, size, price, name, is_active, created_at, updated_at)
            VALUES
                (:id, :company_id, :marketplace, :sku, :supplier_sku, 'UNKNOWN', '0.00', :name, true, :now, :now)
