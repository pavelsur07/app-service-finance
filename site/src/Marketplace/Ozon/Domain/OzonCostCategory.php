...
namespace App\Marketplace\Ozon\Domain;
    ...
    public static function all(): array
    {
        ...
        $cache = [
            ...
            new self(
                ...
                name: 'Временное хранение товара Ozon',
                widgetGroup: 'Услуги доставки и FBO',
                xlsxGroup: 'Услуги FBO',
            ...
            new self(
                ...
                name: 'Маркетинговые акции по операциям Ozon',
                widgetGroup: 'Продвижение и реклама',
                xlsxGroup: 'Продвижение и реклама',
                operationTypes: ['MarketplaceMarketingActionCostOperation'],
            ),
            new self(
                code: 'ozon_marketing_services_subscription',
                name: 'Подписка на маркетинговые сервисы Ozon',
                widgetGroup: 'Продвижение и реклама',
                xlsxGroup: 'Продвижение и реклама',
                operationTypes: ['OperationMarketplaceSubscriptionMarketingServicesCost'],
            ),
            new self(
            ...
            new self(
                ...
                name: 'Дополнительная упаковка на складе Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Услуги FBO',
            ...
            new self(
                code: 'ozon_original_label',
                name: 'Оригинальная этикетка Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
            ...
            new self(
                ...
                name: 'Штраф за отгрузку в нерекомендованный слот Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
            ...
            new self(
                ...
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
                operationTypes: ['DefectFineShipmentDelayRatedCancelled'],
            ),
            new self(
                code: 'ozon_fines_cancellation',
                name: 'Штраф за отмену Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
            ...
            new self(
                ...
                name: 'Индекс ошибок: просроченная отгрузка Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
                operationTypes: ['DefectRateShipmentDelay'],
            ),
            new self(
                code: 'ozon_defect_rate_incomplete',
                name: 'Индекс ошибок: недовложение Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
                operationTypes: ['DefectRateIncomplete'],
            ),
            new self(
                code: 'ozon_defect_rate_wrong_item',
                name: 'Индекс ошибок: неверный товар Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
                operationTypes: ['DefectRateWrongItem'],
            ),
            new self(
                code: 'ozon_defect_rate_cancellation',
                name: 'Индекс ошибок: отмена Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
                operationTypes: ['DefectRateCancellation'],
            ),
            new self(
                code: 'ozon_service_fee_rfbs',
                name: 'Сервисный сбор RFBS Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Другие услуги и штрафы',
            ...
            new self(
                ...
                name: 'Частичная компенсация клиенту Ozon',
                widgetGroup: 'Другие услуги и штрафы',
                xlsxGroup: 'Компенсации и декомпенсации',
                operationTypes: ['OperationMarketplaceServicePartialCompensationToClient'],
            ),
            new self(
