...
use App\Marketplace\Ozon\Infrastructure\Api\OzonAccrualByDayClientInterface;
 ...
 * (удалён 23.09.2026). 967 документов формата v3 переобрабатываются
 * процессорами по сохранённому сырью, загрузчик для этого не нужен.
 *
