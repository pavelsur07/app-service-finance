    ...
    public function buildQueryBuilder(
        ...
        $qb = $this->connection->createQueryBuilder()
            ->select(
                ...
                "COALESCE(SUM((s.cost_breakdown->>'acquiring')::numeric), 0) AS acquiring",
                "COALESCE(SUM((s.cost_breakdown->>'penalties')::numeric), 0) AS penalties",
                "COALESCE(SUM((s.cost_breakdown->>'acceptance')::numeric), 0) AS acceptance",
