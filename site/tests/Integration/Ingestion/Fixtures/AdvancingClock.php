 ...
 *
 * Шаг ровно в секунду, а не в микросекунду: Doctrine пишет отметку с точностью
 * до секунды независимо от объявленной точности колонки, и более мелкий шаг
 * пропал бы при записи.
 */
