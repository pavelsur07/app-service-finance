...
namespace App\Tests\Integration\Marketplace\Wildberries\MessageHandler;
...
use App\Marketplace\Wildberries\MessageHandler\SyncWbFinancialReportDayHandler;
...
final class SyncWbFinancialReportDayHandlerTest extends IntegrationTestCase
{
    ...
    public function testConflictMarksConflictAndThrowsUnrecoverable(): void
    {
        ...
        try {
            ...
            $error = $this->findLastError($status->getId());
            self::assertNotNull($error);
            self::assertSame('App\Marketplace\Wildberries\Exception\WbRawDocumentRefreshConflictException', $error->getErrorClass());
