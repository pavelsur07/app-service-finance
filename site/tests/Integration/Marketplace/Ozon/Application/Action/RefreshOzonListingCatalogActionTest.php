...
namespace App\Tests\Integration\Marketplace\Ozon\Application\Action;
...
use App\Marketplace\Ozon\Application\Action\RefreshOzonListingCatalogAction;
use App\Marketplace\Ozon\Exception\OzonCatalogApiException;
use App\Marketplace\Ozon\Infrastructure\Api\OzonProductCatalogClient;
use App\Marketplace\Ozon\Infrastructure\Normalizer\OzonProductCatalogNormalizer;
use App\Marketplace\Ozon\Infrastructure\Query\OzonListingCatalogUpsertQuery;
...
final class RefreshOzonListingCatalogActionTest extends IntegrationTestCase
{
    ...
    {
        return (string) file_get_contents(\dirname(__DIR__, 5).'/Fixtures/Marketplace/Ozon/'.$file);
    }
