...
use App\Marketplace\Ozon\Exception\OzonCatalogRateLimitException;
use App\Marketplace\Ozon\MessageHandler\SyncOzonListingCatalogHandler;
...
final class SyncOzonListingCatalogHandlerTest extends IntegrationTestCase
{
    ...
    {
        return (string) file_get_contents(\dirname(__DIR__, 4).'/Fixtures/Marketplace/Ozon/'.$file);
    }
