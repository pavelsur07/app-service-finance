...
final class MoySkladStockSnapshotBuilder
{
    ...
    public function build(): MoySkladStockSnapshot
    {
        return new MoySkladStockSnapshot($this->id, $this->companyId, $this->connectionId, new \DateTimeImmutable('2026-09-21T08:00:00+00:00'));
    }
}
