...
final class OzonSalesRawProcessorVersioningTest extends TestCase
{
    ...
    private function buildProcessor(
        ...
        $listingEnsureRef = (new \ReflectionClass(\App\Marketplace\Ozon\Application\Service\OzonListingEnsureService::class))->newInstanceWithoutConstructor();
        ...
        $upsertQuery = (new \ReflectionClass(\App\Marketplace\Ozon\Infrastructure\Query\OzonListingUpsertQuery::class))->newInstanceWithoutConstructor();
