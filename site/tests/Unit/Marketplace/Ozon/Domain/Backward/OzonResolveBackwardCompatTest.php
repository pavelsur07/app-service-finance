...
namespace App\Tests\Unit\Marketplace\Ozon\Domain\Backward;
...
final class OzonResolveBackwardCompatTest extends TestCase
{
    ...
    public function testResolveReturnsSameMappingAsBeforeRefactoring(): void
    {
    ...
    public function testExpectedMappingCount(): void
    {
        $this->assertCount(
            109,
