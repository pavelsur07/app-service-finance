...
final class OzonCostCategoryTest extends TestCase
{
    ...
    private const NEW_OZON_TYPES = [
        ...
        'DefectFineShipmentDelayRatedCancelled' => 'ozon_fine_shipment_delay_rated_cancelled',
        ...
        'DefectFineIncomplete' => 'ozon_fine_incomplete',
        'DefectFineWrongItem' => 'ozon_fine_wrong_item',
