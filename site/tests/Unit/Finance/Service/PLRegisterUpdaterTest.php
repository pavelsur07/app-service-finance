...
final class PLRegisterUpdaterTest extends TestCase
{
    public function testAggregateDocumentsSkipsOperationsWithoutPlCategory(): void
    {
        ...
        $document->setProjectDirection(new ProjectDirection(Uuid::uuid4()->toString(), $company, 'Main'));
        ...
        self::assertArrayHasKey($neutralCategory->getId(), $byCategoryId);
        self::assertSame(125.0, $byCategoryId[$neutralCategory->getId()]['income']);
        self::assertSame(0.0, $byCategoryId[$neutralCategory->getId()]['expense']);
    }
