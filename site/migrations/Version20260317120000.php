...
final class Version20260317120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($schema->hasTable('company')) {
            $this->addSql('ALTER TABLE billing_usage_counter ADD CONSTRAINT fk_billing_usage_counter_company FOREIGN KEY (company_id) REFERENCES company (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        }
    }
