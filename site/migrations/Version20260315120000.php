...
final class Version20260315120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_billing_subscription_company_status_period_end ON billing_subscription (company_id, status, current_period_end)');
