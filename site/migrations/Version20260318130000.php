...
final class Version20260318130000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $hasMarketplaceListingsTable = $schema->hasTable('marketplace_listings');
        $hasProductsTable = $schema->hasTable('products');
        $hasDocumentsTable = $schema->hasTable('documents');
        $hasMarketplaceCostCategoriesTable = $schema->hasTable('marketplace_cost_categories');
        ...
        if ($hasMarketplaceListingsTable) {
        ...
        if ($hasMarketplaceCostCategoriesTable) {
    ...
    {
        $this->addSql('ALTER TABLE marketplace_costs DROP CONSTRAINT IF EXISTS FK_COST_SALE');
        ...
        $this->addSql('ALTER TABLE marketplace_costs DROP CONSTRAINT IF EXISTS FK_COST_COMPANY');
        $this->addSql('ALTER TABLE marketplace_returns DROP CONSTRAINT IF EXISTS FK_RETURN_PRODUCT');
        $this->addSql('ALTER TABLE marketplace_returns DROP CONSTRAINT IF EXISTS FK_RETURN_SALE');
        $this->addSql('ALTER TABLE marketplace_returns DROP CONSTRAINT IF EXISTS FK_RETURN_COMPANY');
        $this->addSql('ALTER TABLE marketplace_sales DROP CONSTRAINT IF EXISTS FK_SALE_DOCUMENT');
        $this->addSql('ALTER TABLE marketplace_sales DROP CONSTRAINT IF EXISTS FK_SALE_PRODUCT');
        $this->addSql('ALTER TABLE marketplace_sales DROP CONSTRAINT IF EXISTS FK_SALE_LISTING');
        $this->addSql('ALTER TABLE marketplace_sales DROP CONSTRAINT IF EXISTS FK_SALE_COMPANY');
