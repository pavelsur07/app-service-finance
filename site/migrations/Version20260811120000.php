 ...
 * по ней отличается владелец от оператора и работает бэкфилл. Права по ней больше
 * не выдаются: с Stage 3 отсутствие шаблона означает отсутствие доступа (fail-closed).
 *
