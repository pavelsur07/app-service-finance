...
final class Version20251124120000 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE finance_loan (id UUID NOT NULL, company_id UUID NOT NULL, name VARCHAR(255) NOT NULL, lender_name VARCHAR(255) DEFAULT NULL, principal_amount NUMERIC(18, 2) NOT NULL, remaining_principal NUMERIC(18, 2) NOT NULL, interest_rate NUMERIC(8, 4) DEFAULT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, payment_day_of_month SMALLINT DEFAULT NULL, status VARCHAR(32) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("COMMENT ON COLUMN finance_loan.created_at IS '(DC2Type:datetime_immutable)'");
        $this->addSql("COMMENT ON COLUMN finance_loan.updated_at IS '(DC2Type:datetime_immutable)'");

        $this->addSql("CREATE TABLE finance_loan_payment_schedule (id UUID NOT NULL, loan_id UUID NOT NULL, due_date DATE NOT NULL, total_payment_amount NUMERIC(18, 2) NOT NULL, principal_part NUMERIC(18, 2) NOT NULL, interest_part NUMERIC(18, 2) NOT NULL, fee_part NUMERIC(18, 2) NOT NULL, is_paid BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("COMMENT ON COLUMN finance_loan_payment_schedule.created_at IS '(DC2Type:datetime_immutable)'");
        $this->addSql("COMMENT ON COLUMN finance_loan_payment_schedule.updated_at IS '(DC2Type:datetime_immutable)'");
    }
