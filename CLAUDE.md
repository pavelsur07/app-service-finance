...
правилами VCS. Он **достижимо зелёный**: сейчас `Found 0 of 2342`, exit 0.
...
Гейтом здесь **не может** служить `make site-cs-check`: он хронически красный
(506 файлов из 2342 по другим правилам `@Symfony`) и возвращает `exit 8`
независимо от того, есть нарушение `declare_strict_types` или нет — для CI норма
и регресс неразличимы.
